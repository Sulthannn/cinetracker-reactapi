                    ...
                    <div class="flex flex-col items-center gap-4">
                        <div class="flex gap-4">
                            <div class="instagram-button">
                                <button onclick="window.location.href='https://www.instagram.com/aggrxarie'" class="relative w-6 h-6 rounded-full group">
                                    <div
                            ...
                            <div class="github-button">
                                <button onclick="window.location.href='https://www.github.com/ArieAnggara'" class="relative w-6 h-6 rounded-full group">
                                    <div
                            ...
                            <div class="linkedin-button">
                                <button onclick="window.location.href='https://www.linkedin.com/in/ari-anggara'" class="relative w-6 h-6 rounded-full group">
                                    <div
                            ...
                            <div class="email-button">
                                <button onclick="window.location.href='mailto:arie.anggara@outlook.com'" class="relative w-6 h-6 rounded-full group">
                                    <div
            ...
            <div
                ...
                <div class="card-content p-4 relative z-10">
                    ...
                    <div class="flex flex-col items-center gap-4">
                        <div class="flex gap-4">
                            <div class="instagram-button">
                                <button onclick="window.location.href='https://www.instagram.com/aisyahwlandr'" class="relative w-6 h-6 rounded-full group">
                                    <div
                                        class="floater w-full h-full absolute top-0 left-0 bg-purple-400 rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"></div>
                                    <div
                                        class="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-purple-400 rounded-full">
                            ...
                            <div class="github-button">
                                <button onclick="window.location.href='https://github.com/aisyahwulandr'" class="relative w-6 h-6 rounded-full group">
                                    <div
                                        class="floater w-full h-full absolute top-0 left-0 bg-black rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"></div>
                                    <div
                                        class="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-black rounded-full">
                            ...
                            <div class="linkedin-button">
                                <button onclick="window.location.href='https://www.linkedin.com/in/aisyahwulandari'" class="relative w-6 h-6 rounded-full group">
                                    <div
                                        class="floater w-full h-full absolute top-0 left-0 bg-blue-500 rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"></div>
                                    <div
                                        class="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-blue-500 rounded-full">
                            ...
                            <div class="email-button">
                                <button onclick="window.location.href='mailto:aisyahwlandr@gmail.com'" class="relative w-6 h-6 rounded-full group">
                                    <div
                                        class="floater w-full h-full absolute top-0 left-0 bg-red-400 rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"></div>
                                    <div
                                        class="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-red-400 rounded-full">
            ...
            <div
                ...
                <div class="card-content p-4 relative z-10">
                    ...
                    <div class="flex flex-col items-center gap-4">
                        <div class="flex gap-4">
                            <div class="instagram-button">
                                <button onclick="window.location.href='https://www.instagram.com/arius_aurelius'" class="relative w-6 h-6 rounded-full group">
                                    <div
                                        class="floater w-full h-full absolute top-0 left-0 bg-purple-400 rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"></div>
                                    <div
                                        class="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-purple-400 rounded-full">
                            ...
                            <div class="github-button">
                                <button onclick="window.location.href='https://github.com/AriusAurelius'" class="relative w-6 h-6 rounded-full group">
                                    <div
                                        class="floater w-full h-full absolute top-0 left-0 bg-black rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"></div>
                                    <div
                                        class="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-black rounded-full">
                            ...
                            <div class="linkedin-button">
                                <button onclick="window.location.href='https://www.linkedin.com/in/arius-aurelius/'" class="relative w-6 h-6 rounded-full group">
                                    <div
                                        class="floater w-full h-full absolute top-0 left-0 bg-blue-500 rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"></div>
                                    <div
                                        class="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-blue-500 rounded-full">
                            ...
                            <div class="email-button">
                                <button onclick="window.location.href='mailto:aureliusarius85@gmail.com'" class="relative w-6 h-6 rounded-full group">
                                    <div
                                        class="floater w-full h-full absolute top-0 left-0 bg-red-400 rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"></div>
                                    <div
                                        class="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-red-400 rounded-full">
            ...
            <div
                ...
                <div class="card-content p-4 relative z-10">
                    ...
                    <div class="flex flex-col items-center gap-4">
                        <div class="flex gap-4">
                            <div class="instagram-button">
                                <button onclick="window.location.href='https://www.instagram.com/putramlddien'" class="relative w-6 h-6 rounded-full group">
                                    <div
                                        class="floater w-full h-full absolute top-0 left-0 bg-purple-400 rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"></div>
                                    <div
                                        class="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-purple-400 rounded-full">
                            ...
                            <div class="github-button">
                                <button onclick="window.location.href='https://github.com/putramlddien'" class="relative w-6 h-6 rounded-full group">
                                    <div
                                        class="floater w-full h-full absolute top-0 left-0 bg-black rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"></div>
                                    <div
                                        class="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-black rounded-full">
                            ...
                            <div class="linkedin-button">
                                <button onclick="window.location.href='https://www.linkedin.com/in/putramlddien'" class="relative w-6 h-6 rounded-full group">
                                    <div
                                        class="floater w-full h-full absolute top-0 left-0 bg-blue-500 rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"></div>
                                    <div
                                        class="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-blue-500 rounded-full">
                            ...
                            <div class="email-button">
                                <button onclick="window.location.href='mailto:putramlddn@gmail.com'" class="relative w-6 h-6 rounded-full group">
                                    <div
                                        class="floater w-full h-full absolute top-0 left-0 bg-red-400 rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"></div>
                                    <div
                                        class="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-red-400 rounded-full">
            ...
            <div
                ...
                <div class="card-content p-4 relative z-10">
                    ...
                    <div class="flex flex-col items-center gap-4">
                        <div class="flex gap-4">
                            <div class="instagram-button">
                                <button onclick="window.location.href='https://www.instagram.com/sulthanizza_'" class="relative w-6 h-6 rounded-full group">
                                    <div
                                        class="floater w-full h-full absolute top-0 left-0 bg-purple-400 rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"></div>
                                    <div
                                        class="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-purple-400 rounded-full">
                            ...
                            <div class="github-button">
                                <button onclick="window.location.href='https://github.com/Sulthannn'" class="relative w-6 h-6 rounded-full group">
                                    <div
                                        class="floater w-full h-full absolute top-0 left-0 bg-black rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"></div>
                                    <div
                                        class="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-black rounded-full">
                            ...
                            <div class="linkedin-button">
                                <button onclick="window.location.href='https://www.linkedin.com/in/sulthan-izza-falqahi/'" class="relative w-6 h-6 rounded-full group">
                                    <div
                                        class="floater w-full h-full absolute top-0 left-0 bg-blue-500 rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"></div>
                                    <div
                                        class="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-blue-500 rounded-full">
                            ...
                            <div class="email-button">
                                <button onclick="window.location.href='mailto:sulthanizza11@gmail.com'" class="relative w-6 h-6 rounded-full group">
                                    <div
                                        class="floater w-full h-full absolute top-0 left-0 bg-red-400 rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"></div>
                                    <div
                                        class="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-red-400 rounded-full">
