...
<body>
    ...
    <section id="dataPenerima" class="w-full h-[25rem] relative">
        ...
        <div class="absolute inset-0 flex flex-col justify-center items-center text-white text-center">
            <h1 class="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold">Arsip Penerima - Pembina Lingkungan</h1>
            <p class="text-sm sm:text-base md:text-lg mt-2 sm:mt-4">Berikut adalah daftar penerima Penghagaan Kalpataru dalam kategori Pembina Lingkungan</p>
        </div>
    </section>
